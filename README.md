...
| driver | The web driver to navigate the web pages.  | Currently only 'chromedriver'. Follow the the docs on https://chromedriver.chromium.org/ to include the chromedriver in the system variables path. |
